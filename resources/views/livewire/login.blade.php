    ...
    <form class="space-y-6" action="#" method="POST">
        @if(!$isSend)
            <div>
                ...
                <div class="mt-2">
                    <input wire:model="phone" id="number" placeholder="+7 (___) ___-__-__" name="phone" type="text" autocomplete="phone" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
            </div>
        @endif
        ...
        @if($isSend)
            <div class="mt-2">
                ...
                <input wire:model.defer="code" id="code" placeholder="__-__" type="text" required class="block w-full rounded-md border-0 px-1.5 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            </div>
